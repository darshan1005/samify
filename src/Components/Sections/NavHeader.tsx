...
//             const matchedNav = navItems.find(item => item.target === visibleId);
...
//       },
//       {
//         threshold: 0.6, // Adjust this to control how much should be visible to count
//       }
//     );
...
//       // Simple top detection for Home section
//       if (scrollTop < 200 && activeNav !== 'Home') {
//         setActiveNav('Home');
...
const NavHeader = () => {
  ...
  useEffect(() => {
    ...
    return () => observer.disconnect();
  }, [activeNav, isMobile]); // Add isMobile dependency
