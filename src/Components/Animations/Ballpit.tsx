...
const Ballpit: React.FC<BallpitProps> = ({
  ...
  useEffect(() => {
    ...
    // Lower the count for better performance on most devices
    const optimizedProps = {
      ...props,
      count: typeof props.count === 'number' ? props.count : 40, // default to 40 if not set
      gravity: typeof props.gravity === 'number' ? props.gravity : 0.7,
      friction: typeof props.friction === 'number' ? props.friction : 0.98, // more friction for less CPU
      wallBounce: typeof props.wallBounce === 'number' ? props.wallBounce : 0.95,
      followCursor,
    };

    spheresInstanceRef.current = createBallpit(canvas, optimizedProps);
